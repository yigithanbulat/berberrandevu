...
<head>
	...
	<link rel="stylesheet" href="<?=$h->get['base_url']?>./admin/assets/css/datepicker.css" rel="stylesheet">
...
<body id="page-top" class="theme-purple">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
		...
		<div class="collapse navbar-collapse" id="navbarNavDropdown">
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<a href="./admin" class="nav-link" title="Admin Paneli"><i class="bi bi-file-person-fill"></i> Admin Paneli</a>
				</li>
			</ul>
		</div>
	</nav>
	<div class="container">
		...
		<script src="<?=$h->get['base_url']?>/admin/assets/js/datepicker.js"></script>
		<script>
